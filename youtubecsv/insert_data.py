...
data_fileUS = "youtube-new/USvideos.csv"
data_fileCA = "youtube-new/CAvideos.csv"
...
#print(usVideosDict)
usFile = open("youtube-new/US_category_id.json",)
usCat = json.load(usFile)
#print(uScat)
caFile = open("youtube-new/CA_category_id.json",)
caCat = json.load(caFile)
